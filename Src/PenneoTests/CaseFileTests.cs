...
namespace PenneoTests
{
    ...
    public class CastFileTests
    {
        ...
        [Test]
        public async Task CreateCaseFile()
        {
            var c = new PenneoConnector("7dd28fc9ccd89cd0b4fcbdeac1b6547fd7f76282af4112d93999cc673d21cca6", "238934dbddcd276c9b753d42d7b1124eada2ae0ecfb6588cacbec7a6d85677d4");
            ...
            //
            await sigLine.SetSigner(c, signer);

            // Update the signing request
            //
            var signingRequest = await signer.GetSigningRequest(c);
            ...
            await signingRequest.Persist(c);

            // Create the signing request link
            //
            var link = await signingRequest.GetLink(c);
